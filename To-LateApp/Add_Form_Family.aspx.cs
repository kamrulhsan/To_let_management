...
{
    public partial class Add_Form_Family : System.Web.UI.Page
    {
        ...
        protected void submitButton_Click(object sender, EventArgs e)
        {
            ...
            if (imageFileUpload.HasFile)
            {
                try
                {
                    ...
                    string query = "Insert into FamilySublet(Property_Owner,HouseName,contact,description,room,payment,Imagepath,Imagename) " +
                              "values('" + propertyOwnerTextBox.Text + "','" + houseNameTextBox.Text + "','" + contactTextBox.Text + "','" +
        ...
        protected void Subb_Click(object sender, EventArgs e)
        {
