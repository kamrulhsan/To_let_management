<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Family.aspx.cs" Inherits="To_LateApp.Family" %>
        ...
        <table style="width: 100%; height: 490px;">
            <tr>
                ...
                <td class="auto-style10">
                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <img alt="" class="auto-style17" src="Images/enroll.png" />Offer a Property to Rent
                </strong>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <table style="width: 100%; height: 360px;">
                        ...
                        <tr>
                            <td class="auto-style12">House Name:</td>
                            <td>
                                <asp:TextBox ID="houseNameTextBox" runat="server" Width="226px"></asp:TextBox>
                                <br />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="houseNameTextBox" ErrorMessage="Enter house name" style="color: #FF0000"></asp:RequiredFieldValidator>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style14">
                                <br />
                                <asp:FileUpload ID="imageFileUpload" runat="server" CssClass="form-control" style="text-align: left" Width="335px" AllowMultiple="True" />
                            </td>
