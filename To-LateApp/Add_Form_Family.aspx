<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Form_Family.aspx.cs" Inherits="To_LateApp.Add_Form_Family" %>
        ...
        <table style="width: 100%; height: 490px;">
            <tr>
                ...
                <td class="auto-style10">
                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    <img alt="" class="auto-style17" src="Images/enroll.png" />Offer a Sublet Room to Rent
                </strong>
                </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="paymentDropDownList" runat="server" CssClass="form-control">
                                    <asp:ListItem>3000 TK</asp:ListItem>
                                    <asp:ListItem>4000 TK</asp:ListItem>
                                    <asp:ListItem>5000 TK</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
