...
{
    public partial class GirlRoom : System.Web.UI.Page
    {
        ...
        protected void submitButton_Click(object sender, EventArgs e)
        {
            ...
            if (imageFileUpload.HasFile)
            {
                try
                {
                    ...
                    string query = "Insert into GirlsRoom(Property_Owner,HouseName,contact,description,room,payment,Imagepath,Imagename) " +
